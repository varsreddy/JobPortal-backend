...
app.use(cors({
  origin: [process.env.CLIENT_URL || "http://localhost:5173", "https://job-portal-frontend-six-lime.vercel.app"],
  credentials: true
}));
...
// ❗️Important: Export the serverless handler instead of starting a server
